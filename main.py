...
# Update your object upload route
...
def object_upload():
    ...
    if file:
        try:
            ...
            # Perform detection
            detection_result, audio_path, timestamp = object_detection_upload.detect_objects(file_path)
            
            # Handle case where audio_path might be None
            audio_file = os.path.basename(audio_path) if audio_path else None
            
            return render_template(
                'object-detection-upload.html',
            ...
            return render_template('object-detection-upload.html', error=str(e))
